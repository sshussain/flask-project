...
manages database.
"""
from pdqs.orm_entity import engine, BookReviewCrud
pdqs.orm_entity.init_db()
...
def get_all_authors() -> Response:
    ...
    author_results = AuthorResponseDto(names = crud.get_all_authors())
